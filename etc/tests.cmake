...
add_custom_target (check_webget COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 120 -R 'webget')

add_custom_target (check1 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 120 -R '^byte_stream_|^reassembler_')

add_custom_target (check2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 120 -R '^byte_stream_|^reassembler_|^wrapping|^recv')
...
add_custom_target (check5 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 120 -R '^net_interface')

add_custom_target (check6 COMMAND ${CMAKE_CTEST_COMMAND} --verbose --stop-on-failure --timeout 120 -R '^net_interface|^router')
